...
public class PclClient {
	...
	public PclClient(File clientConfigFile, File readerConfig, File[] listenerConfigFiles) {
	...
	public static void printUsage() {
		CmdLineParser parser = new CmdLineParser(new PclClient());
		System.out.print("Usage: java " + PclClient.class.getCanonicalName());
