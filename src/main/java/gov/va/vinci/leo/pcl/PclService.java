...
public class PclService {
  ...
  public static void main(String[] args) {
    PclService current_service = new PclService();
    if (args.length == 0) {
  ...
  public static void printUsage() {
    CmdLineParser parser = new CmdLineParser(new PclService());
    System.out.print("Usage: java " + PclService.class.getCanonicalName());
