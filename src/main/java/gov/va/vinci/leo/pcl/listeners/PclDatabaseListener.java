...
public class PclDatabaseListener extends BaseDatabaseListener {
     ...
     * @return
     */
    public static PclDatabaseListener createNewListener(
        ...
        return new PclDatabaseListener(databaseConnectionInformation, insertStatement,
